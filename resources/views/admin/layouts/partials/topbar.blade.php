    ...
    <div class="header-right">
        <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="messages-header">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-body">
                        ...
                        <img src="{{asset('make/global/images/avatars/avatar3.png')}}" alt="avatar 3">
                        </span>
                                <div class="clearfix">
                                    <div>
                        ...
                        <img src="{{asset('make/global/images/avatars/avatar4.png')}}" alt="avatar 4">
                            ...
                            <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="{{asset('make/global/images/avatars/avatar5.png')}}" alt="avatar 5">
                        </span>
                                <div class="clearfix">
                                    <div>
                            ...
                            <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="{{asset('make/global/images/avatars/avatar6.png')}}" alt="avatar 6">
                        </span>
                                <div class="clearfix">
                                    <div>
            ...
            <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img src="{{asset('make/global/images/avatars/user1.png')}}" alt="user image">
                    <span class="username">Hi, {{ Auth::guard('admin_user')->user()->first_name }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li>
