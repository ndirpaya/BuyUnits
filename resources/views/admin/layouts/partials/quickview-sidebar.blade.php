                ...
                <div class="chat-body current">
                    ...
                    <div class="chat-list">
                        ...
                        <ul>
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar13.png')}}" alt="avatar" />
                                </div>
                            ...
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar5.png')}}" alt="avatar" />
                            ...
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar10.png')}}" alt="avatar" />
                                </div>
                                <div class="user-details">
                                    <div class="user-name">Bobby Brown</div>
                    ...
                    <div class="chat-list">
                        ...
                        <ul>
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar7.png')}}" alt="avatar" />
                                    <div class="pull-right badge badge-danger">3</div>
                                </div>
                                <div class="user-details">
                            ...
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar11.png')}}" alt="avatar" />
                                </div>
                                <div class="user-details">
                            ...
                            <li class="clearfix">
                                <div class="user-img">
                                    <img src="{{asset('make/global/images/avatars/avatar8.png')}}" alt="avatar" />
                                </div>
                                <div class="user-details">
                            ...
                            <li class="img">
                                <div class="chat-detail">
                                    ...
                                    <div class="conversation-img">
                                        <img src="{{asset('make/global/images/avatars/avatar4.png')}}" alt="avatar 4"/>
                                    </div>
